...
/**
 * Function finds crossovers of x array under y array values and flag it with true value where it happens
 * @param x
 * @param y
 */
export const crossunder = (x: Decimal.Value[], y: Decimal.Value[]): boolean[] | null => {
